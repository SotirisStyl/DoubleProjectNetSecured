      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: const [
            ...
            Text("There are four main features of NetSecured:", 
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
            Text("1. Learn about different concepts of cybersecurity"),
            Text("2. Quiz yourself on network security"),
            Text("3. Fill the Gaps quizzes"),
            Text("4. Daily Trivia\n"),
            Text("How to use NetSecured",
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
            ...
            Text("6. Try Fill the Gaps for random challenges"),
            Text("7. Check Daily Trivia for daily bonus points\n"),
            Text(
            ...
            Text("• Fill the Gaps is a quiz mode where you answer random questions from various topics."),
            Text("• There are three difficulty levels: Easy, Medium, and Hard."),
            Text("• Points are awarded based on difficulty: Easy grants 10 points, Medium 20, Hard 40."),
            Text("• Incorrect answers deduct points: Easy -2, Medium -4, Hard -8."),
            Text("• Completing the quiz grants an additional 50 points.\n"),
            Text(
              "Daily Trivia",
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
            Text("• Daily Trivia offers one question per day for bonus points."),
            Text("• The question is consistent for all users on the same day."),
            Text("• Answering correctly grants 50 points."),
            Text("• You can only attempt it once per day.\n"),
            Text(
